    ...
    <div class="row-my-2">
        ...
        <div class="col-6">
            <label for="name" class="">Origin
                ...
                <input type="text" class="form-control" placeholder="Origin" value="{{old('origin')}}" name="origin">
        </div>
        <div class="col-2"></div>
        <div class="col-6">
            <label for="name" class="">Brand
                ...
                <input type="text" class="form-control" placeholder="Brand" value="{{old('brand')}}" name="brand">
        </div>
    </div>
